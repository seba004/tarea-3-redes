...
grafo_tarea=[['a','b',1],['a','g',4],['a','i',10],['b','c',9],['b','a',1],['b','e',8],['c','b',9],['c','d',2],['d','c',2],['d','f',4],['d','e',9],['d','i',2],['e','b',8],['e','f',2],['e','d',9],['e','i',1],['f','d',4],['f','e',2],['f','h',6],['g','a',4],['g','h',7],['h','g',7],['h','f',6],['i','e',1],['i','d',2],['i','a',10]]
...
def impresion(nodo):
    ...
    fichero =open('routers_preg2.txt','a')
    fichero.write("\n")
    fichero.write("----------------|\n")
